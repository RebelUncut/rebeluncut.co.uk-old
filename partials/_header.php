...
<head>
	...
	<title>Rebel Uncut - <?php echo "$title" ?></title>
			...
			<ul>
				...
				<li class="get-in-touch">
					...
					<a href="tel:01212364588">
						<i class="fa fa-phone"></i> 01212364588
					</a>
				</li>
			</ul>
			<div class="yrs">
				<a href="/yrs">
					We're proud to support young local talent from Birmingham with Young Rewired State. Find out more by clicking here.
				</a>
			</div>
		</nav>
		<div class="lower-nav">
			<a href="/" class="brand">
				<img src="/assets/img/logo-purple.png" alt="Rebel Uncut Logo">
			</a>
